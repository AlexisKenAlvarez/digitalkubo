        ...
        <>
            ...
            <nav className={`w-full h-auto transtion-bg ease-in-out duration-300 fixed top-0 left-0 border-b-[1px] border-b-black/5 z-30 ${navDesktopActive ? 'bg-button md:bg-white md:text-button text-white' : ' bg-white text-button'}`}>
                ...
                <div className="max-w-[1500px] w-full mx-auto flex justify-between px-5 py-3">
                    ...
                    <button className={` mt-2 mr-3 flex-col items-end gap-y-3 md:hidden flex transition-all ease-in-out duration-300 ${navDesktopActive ? 'rotate-[360deg]' : 'rotate-0'}`} onClick={handleNavDesktop}>
                        <div className={` transition-all ease-in-out duration-300 ${navDesktopActive ? 'bg-white rotate-[-45deg] w-8 translate-y-[9px] h-[3px]' : 'w-8 h-[3px] bg-nav'}`}></div>
                        <div className={` transition-all ease-in-out duration-300  ${navDesktopActive ? 'bg-white rotate-[45deg] w-8 h-[3px] -translate-y-[6px]' : 'w-6 h-[3px] bg-nav'}`}></div>
                    </button>
                </div>
