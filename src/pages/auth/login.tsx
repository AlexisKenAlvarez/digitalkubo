...
const page = () => {
    ...
    const signupSchema = z.object({
        email: z.string()
            .email()
            .refine((e) =>
                e.endsWith("@cvsu.edu.ph"),
                "Email must be CvSU email."
            ),
            ...
            <div className="flex items-center w-full sm:max-w-[1400px] mx-auto h-full sm:h-fit sm:-mt-24">
                ...
                <div className="sm:w-fit w-full h-screen sm:h-auto px-10 py-7 sm:border-[1px] bg-white border-black/5 rounded-lg drop-shadow-sm mx-auto">
                    <div className="leading-loose text-center">
                        <h1 className="text-4xl sm:text-[48px] font-primary font-bold text-black">Welcome back!</h1>
                    ...
                    <div className="flex flex-col gap-y-3 mt-10">
                        ...
                        <div className="flex items-center gap-x-4">
                            ...
                            <p className="text-black/50 text-sm flex-shrink-0">you can also</p>
                            <div className="w-full h-[1px] bg-black/10"></div>
                        </div>

                        <Button className='bg-[#4081ec] hover:bg-[#4081ec]/90 relative' onClick={() => { signIn('google') }}>
                        ...
                        <Link href="/auth/signup">
                            <h3 className="text-black/50 text-center">Don&apos;t have an account? <span className="font-bold text-button hover:text-nav cursor-pointer">Sign up</span></h3>
                        </Link>

                        <Link href="/auth/reset">
                            <h3 className="text-black/50 text-center hover:text-nav hover:underline">Trouble signing in?</h3>
                        </Link>
                    </div>
