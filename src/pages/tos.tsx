      ...
      <div className="max-w-[1400px] w-full mx-auto flex flex-wrap px-6 md:px-20">
        <div className="w-full mx-auto">
          ...
          <p className="font-secondary text-justify py-4">
            ...
            conditions. Do not continue to use DigitalKubo if you do not agree
          ...
          <p className="font-secondary text-justify py-4">
            Unless otherwise stated, DigitalKubo and/or its licensors own the
            intellectual property rights for all material on DigitalKubo. All
            intellectual property rights are reserved. You may access this from
            DigitalKubo for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p className="font-secondary text-justify py-4">You must not:</p>
          <ol>
            <li>Republish material from DigitalKubo</li>
            <li>Sell, rent or sub-license material from DigitalKubo</li>
            <li>Reproduce, duplicate or copy material from DigitalKubo</li>
            <li>Redistribute content from DigitalKubo</li>
          </ol>

          <p className="font-secondary text-justify py-4">
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            DigitalKubo does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of DigitalKubo,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            DigitalKubo shall not be liable for the Comments or for any
          ...
          <p className="font-secondary text-justify py-4">
            DigitalKubo reserves the right to monitor all Comments and to remove
          ...
          <p className="font-secondary text-justify py-4">
            You hereby grant DigitalKubo a non-exclusive license to use,
          ...
          <p className="font-secondary text-justify py-4">
            ...
            visibility of the hyperlink compensates the absence of DigitalKubo;
          ...
          <p className="font-secondary text-justify py-4">
            ...
            sending an e-mail to DigitalKubo. Please include your name, your
