        ...
        <div className="max-w-[1400px] w-full mx-auto flex flex-wrap px-6 md:px-20">
          <div className="w-full mx-auto">
            ...
            <p className="font-secondary text-justify py-4">
              At DigitalKubo, accessible from www.digitalkubo.com, one of our
              ...
              and recorded by DigitalKubo and how we use it.
            </p>
            <p className="font-secondary text-justify py-4">
            ...
            <p className="font-secondary text-justify py-4">
              ...
              that they shared and/or collect in DigitalKubo. This policy is not
            ...
            <ul className="py-2">{listItems}</ul>
            ...
            <p className="font-secondary text-justify py-4">
              DigitalKubo follows a standard procedure of using log files. These
            ...
            <p className="font-secondary text-justify py-4">
              ...
              the advertising partners of DigitalKubo.
            </p>

            <p className="font-secondary text-justify py-4">
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on DigitalKubo,
            ...
            <p className="font-secondary text-justify py-4">
              Note that DigitalKubo has no access to or control over these
            ...
            <p className="font-secondary text-justify py-4">
              DigitalKubo's Privacy Policy does not apply to other advertisers
            ...
            <p className="font-secondary text-justify py-4">
              DigitalKubo does not knowingly collect any Personal Identifiable
