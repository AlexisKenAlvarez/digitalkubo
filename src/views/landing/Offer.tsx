            ...
            <section className="w-full px-24 2xl:px-5 pt-10 bg-white border-y">
                <div className="max-w-[1400px] w-full">
                    ...
                    {templates.map(function (template) {
                        return (
                            <div className="text-[#0000004f] font-secondary font-medium" key={template.desc}>
                                <div className="w-full py-4 px-20"> <div className=" bg-[#D9D9D9] p-12"></div></div>
                                <div className="w-full text-justify p-6"><p className="text-[#0000004f] font-secondary font-medium">{template.desc}</p></div>
                            </div>
                        )
                    })}
                    </div>
