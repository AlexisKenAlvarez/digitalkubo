...
const Location = () => {
  return (
    <main className={` ${montserrat.className}`}>
      <div className="w-full flex flex-col h-auto items-center justify-center px-5 py-10">
        <h1 className="text-center text-[#D1770E] text-4xl font-bold p-2">
          Location
        </h1>
        <h1 className="text-center text-[#000000] text-1xl md:text-1xl py-4 ">
          911 T.A Tandang Sora, 70th Floor TnT Building, Ohio, Calabarzon 619,
          PH
        </h1>
